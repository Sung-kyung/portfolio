function Topbar__init() {
    $('#top-bar > .top-wrap').mouseenter(function() {
        $('#top-bar > .sub-bg').addClass('active');
        $('#top-bar > .top-wrap > .gnb > li > .sub-menu').addClass('active');
    });
    $('#top-bar > .sub-bg').mouseleave(function() {
        $('#top-bar > .sub-bg').removeClass('active');
        $('#top-bar > .top-wrap > .gnb > li > .sub-menu').removeClass('active');
    });
}
